    ...
    <div className="py-32">
      ...
      <ul className="ml-5 list-disc">
        ...
        <li className="p-5 relative">
          ...
          <p className="mt-5">Social media scraping site, I work as a part of the front-end team. Build with Nuxt JS and Tailwind CSS. This app shows information like total followers, account growth and etc.</p>
        </li>
      </ul>
    </div>
  );
